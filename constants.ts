...
export const PROJECTS_DATA: ProjectItem[] = [
  {
    ...
    title: "UCRS",
    description:
      "A custom-designed corporate website built with Next.js, Tailwind CSS, and Shadcn UI",
    link: "#",
  },
  {
    id: "2",
    title: "OwlSourcing",
    description:
      "A WordPress-based corporate website built with Elementor for a Chinese sourcing company.",
    link: "#",
  },
  {
    id: "3",
    title: "NovinCloud",
    description:
      "A Next.js cloud management console powered by a customized Kubectl API.",
    link: "#",
  },
  {
    id: "4",
    title: "Safes.so",
    description:
      "Parental control web dashboard built with React.js, Material UI, and Zustand.",
    link: "#",
  },
];
